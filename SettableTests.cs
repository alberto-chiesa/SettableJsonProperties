...
namespace System
{
    ...
    public class SettableTests
    {
        ...
        {
            ContractResolver = new Gianos.Utils.SettableUtils.SettableContractResolver()
        };

        
        public object[] UndefinedSerializationTests = {
            new object[] {new Settable<int>(10), Settable<int>.Undefined, "{\"A\":10}"},
            new object[] {Settable<int>.Undefined, new Settable<int>(0),  "{\"B\":0}"},
            new object[] {new Settable<int>(null), Settable<int>.Undefined, "{\"A\":null}"},
            new object[] {Settable<int>.Undefined, Settable<int>.Undefined, "{}"}
        };

        [Test]
        [TestCaseSource("UndefinedSerializationTests")]
